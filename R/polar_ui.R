...
polar_ui <- function(id){
  ...
  shiny::sidebarLayout(
    shiny::sidebarPanel(
      shiny::sliderInput(ns("a"), "Parameter a", min = -3, max = 3, step = 0.01, value = 2, width = "100%"),
      shiny::sliderInput(ns("b"), "Parameter b", min = -3, max = 3, step = 0.01, value = 2, width = "100%"),
      shiny::sliderInput(ns("c"), "Parameter c", min = -3, max = 3, step = 0.01, value = 3, width = "100%"),
      shiny::sliderInput(ns("d"), "Parameter d", min = -3, max = 3, step = 0.01, value = 2, width = "100%"),
